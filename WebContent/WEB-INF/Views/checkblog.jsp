	...
	$("#demo2").paginate(
			{
				...
				onChange : function(page) {
					...
					function mydata(n) {
						var page=n;
						$.post(
										"BlogController/findNoCheckBlog.html",
										{
											data : n,
										...
										function(re) {
											...
											$.each(
															...
															function(n, value) {
																var str = '<tr><td style="width:100px;" class="center">'
																		...
																		+ '</td><td class="center">'
																		+ value.blogtype
																		+ '</td><td class="center">'+ value.blog_content+'</td><td class="center"><a  class="btn">查看博文</a>  </td></tr>';
											...
											$("a.btn").click( function() {
												var blog_ids=$(this).parent().parent().find("td").eq(0).text();
												var s=$(this).parent().parent().find("td").eq(3).text();
												var user_name=$(this).parent().parent().find("td").eq(2).text();
												var content=$(this).parent().parent().find("td").eq(6).text();
												...
												$("#div1").append(str);
												 ...
												 $("#btnno").click(function  () {
													...
													$("#btnpass").click(function  () {
														$("#s_bg").fadeOut()
														$("#div1").empty();
														var xinxi={"blog_id":blog_ids,"user_id":user_id,"censorship_result":$("#cen_result").val()};
														var fjson= JSON.stringify(xinxi);
														$.post("BlogController/passBlog.html", {
															data:fjson
													...
													$("#btnnopass").click(function  () {
														...
														var xinxi={"blog_id":blog_ids,"user_id":user_id,"censorship_result":$("#cen_result").val()};
														var fjson= JSON.stringify(xinxi);
														$.post("BlogController/NoPassBlog.html", {
															data:fjson
		...
		<section class="pop_bg" id="s_bg">
			<div class="pop_cont">
				...
				<div class="pop_cont_input">
					<ul>
						<li>
							<span id="username">用户ID:来年我为你摇桃花</span>
							
						</li>
						<li>
							<span id="date">发表时间:2016.5.16</span>
						...
						<li>
						<textarea id="content" class="textarea" style="height:30px;width:350px;"disabled="true "></textarea>
						</li>
						<li>
						...
						<li>
						<textarea class="textarea" style="height:15px;width:350px;" placeholder="如果不通过请输入原因" id="cen_result"></textarea>
						</li>
				...
				<input type="button" value="通过" class="input_btn trueBtn" id="btnpass"/>
				<input type="button" value="不通过" class="input_btn falseBtn" id="btnnopass" />
